...
import CirclesTestImage from '../../assets/images/sehtestzeichen/astigmatismus-kreise.svg';
import LinesTestImage from '../../assets/images/sehtestzeichen/astigmatismus-sonnenrad.svg';
import LongButton from '../../components/LongButton';
import useSharpnessVisionTestController from '../../hooks/controllers/VisionTests/Sharpness';
...
export default function SharpnessVisionTestScreen(
  props: NativeStackScreenProps<RootStackParamList, 'SharpnessVisionTest'>,
) {
  ...
  const {
    ...
    testStage,
  } = useSharpnessVisionTestController(navigation);
...
möglichst entspannen.`}
        ...
        <>
          <View style={styles.imageWrapper}>
            {testStage === 'circles' ? (
              <CirclesTestImage width={testImageSize} height={testImageSize} />
            ) : (
              <LinesTestImage width={testImageSize} height={testImageSize} />
            )}
          </View>
          <View style={styles.bottomWrapper}>
            <Text style={styles.testText}>
              {testStage === 'circles'
                ? 'Sehen alle Linien in den Kreisen gleich scharf und dunkel aus?'
                : 'Sehen alle Linien in allen Richtung gleich scharf und dunkel aus?'}
            </Text>
